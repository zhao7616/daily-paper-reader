...
tldr: 本研究针对存在传感器故障和外部干扰的异构网络化线性系统，提出了一种基于协同观测器的 H-infinity 容错跟踪控制框架。通过设计增广观测器同时重构状态与故障，并结合分布式积分动作实现恒定参考点的精确跟踪。该方法利用 LMI 技术确保了系统的鲁棒稳定性和干扰抑制能力，在多种网络拓扑下验证了其在传感器失效情况下的可靠性与可扩展性。
source: arxiv
